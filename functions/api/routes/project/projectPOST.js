...
const { userDB, projectDB, typeDB, tagDB, positionDB, fieldDB, projectPeriodDB, periodDB, projectPositionDB, goalDB, projectGoalDB, projectTagDB, projectFieldDB, memberDB } = require('../../../db');
